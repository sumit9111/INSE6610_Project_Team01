...
We had different types of data gathered from different devices including the smart phone and base stations. So, we had images which should be browsed and information that should be extracted. 
...
In our case, pythos was used on jupyter notebook editor \cite{Ali_2} to use the parse tools developed to retrieves the activity records in the database of the devices.
...
\bibitem{pari_3}
"Autopsy Provided features, " [Online]. Available: https://www.sleuthkit.org/autopsy/features.php
