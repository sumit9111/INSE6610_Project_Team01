...
WWW: \url{http://www.michaelshell.org/contact.html}}
\and
\IEEEauthorblockN{Homer Simpson}
\IEEEauthorblockA{Twentieth Century Fox\\
Springfield, USA\\
Email: \url{homer@thesimpsons.com}}
\and
...
Discuss papers related to your study. Break into sub-sections
if necessary~\cite{oo-metrics-practice-2006,marfcat-nlp-ai2014,%
...
Subsubsection text here. Cite per IEEE guidelines~\cite{ieee-citation-reference}.

\subsection{Summary}

Synthesis and summary of findings from the rest of
the background, etc.
...
Provide a formal definition for the metrics used in your study. Use a 
separate sub-section for each metric. You may add small computation examples 
for the metrics you consider more difficult to understand. The rest will
go into the background.

\subsection{Metrics calculation/implementation details}

Provide interesting implementation details for the more challenging metrics 
you implemented as well as tools used.

\section{Empirical Study}

Provide a high-level description of the study Use subsections as necessary 
per project specification. Below are some examples.

\subsection{Examined variables}

Describe your independent and dependent variables.

\subsection{Examined hypotheses}

Describe the null and alternative hypotheses.

\subsection{Experiment design}

List the projects you have selected for the analysis. Justify your selection. 
Describe their characteristics (size, history, version, revisions, 
development team, development practices, etc.)

\subsection{Data collection}

Describe the way that you collected the data (developed techniques for data 
collection, used tools, etc.)
